...
// Game_Feedback stores non-blocking transition timers owned by Game and
// advanced once per render frame.
...
// request_gameplay_feedback triggers the screen shake requested by the
// current frame's gameplay ticks.
