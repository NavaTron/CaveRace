...
// Pointer_Input stores mouse state in the fixed WINDOW_WIDTH x WINDOW_HEIGHT
// presentation space. Keeping window scaling and letterboxing out of menu
// logic gives every menu the same hit-testing coordinates as its renderer.
