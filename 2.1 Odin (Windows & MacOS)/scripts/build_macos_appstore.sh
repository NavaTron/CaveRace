...
PKG_PATH="$DIST_DIRECTORY/$APP_NAME.pkg"
...
RELATIVE_OUT_PREFIX="../dist/macos-appstore/$APP_NAME.app/Contents/MacOS/CaveRace"
...
echo "Upload the .pkg with Apple's Transporter app."
